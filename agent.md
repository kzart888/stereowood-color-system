...
- 2026-02-06: Vue 3 app and related migration docs archived under `archives/phase1-vue3-2026-02-06/`. Legacy UI remains production.
- 2025-10-03: Artwork scheme formula-matching redesign plan drafted. Archived at `archives/phase1-vue3-2026-02-06/docs/development/artwork-scheme-formula-plan.md`.
...
- 2025-10-08: Phase D 候选自配色流程落地，SchemeDialog 可根据手写配方匹配自配色、快速套用或清除，并更新文档与单元测试。
- Current frontend progress:
  ...
  - Docs: Vue 3 migration docs archived at `archives/phase1-vue3-2026-02-06/docs/development/`. `docs/development/backend-api.md` remains the active Express reference.
- Near-term priorities:
  1. Phase E：完善作品/字典视图的重复 & 异常标记，补齐单元 + Chrome DevTools 验证。
  2. Phase F：补完后端哈希查询及历史审计接口，并扩展文档/浏览器回归验证。
